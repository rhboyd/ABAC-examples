...
__jsii_assembly__ = jsii.JSIIAssembly.load("@aws-cdk/aws-route53", "1.4.0", __name__, "aws-route53@1.4.0.jsii.tgz")
...
class CfnHostedZoneProps():
    ...
    @property
    def vpcs(self) -> typing.Optional[typing.Union[typing.Optional[aws_cdk.core.IResolvable], typing.Optional[typing.List[typing.Union["CfnHostedZone.VPCProperty", aws_cdk.core.IResolvable]]]]]:
        """``AWS::Route53::HostedZone.VPCs``.
...
class AaaaRecordProps(RecordSetOptions):
    def __init__(self, *, zone: "IHostedZone", comment: typing.Optional[str]=None, record_name: typing.Optional[str]=None, ttl: typing.Optional[aws_cdk.core.Duration]=None, target: "AddressRecordTarget"):
    ...
    @property
    def target(self) -> "AddressRecordTarget":
        """The target."""
        return self._values.get('target')
