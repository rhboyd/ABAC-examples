...
import aws_cdk.core
__jsii_assembly__ = jsii.JSIIAssembly.load("@aws-cdk/aws-s3", "1.4.0", __name__, "aws-s3@1.4.0.jsii.tgz")
...
@jsii.data_type(jsii_type="@aws-cdk/aws-s3.BucketAttributes", jsii_struct_bases=[], name_mapping={'bucket_arn': 'bucketArn', 'bucket_domain_name': 'bucketDomainName', 'bucket_dual_stack_domain_name': 'bucketDualStackDomainName', 'bucket_name': 'bucketName', 'bucket_regional_domain_name': 'bucketRegionalDomainName', 'bucket_website_new_url_format': 'bucketWebsiteNewUrlFormat', 'bucket_website_url': 'bucketWebsiteUrl'})
class BucketAttributes():
    def __init__(self, *, bucket_arn: typing.Optional[str]=None, bucket_domain_name: typing.Optional[str]=None, bucket_dual_stack_domain_name: typing.Optional[str]=None, bucket_name: typing.Optional[str]=None, bucket_regional_domain_name: typing.Optional[str]=None, bucket_website_new_url_format: typing.Optional[bool]=None, bucket_website_url: typing.Optional[str]=None):
...
class CfnBucket(aws_cdk.core.CfnResource, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-s3.CfnBucket"):
    ...
    class RuleProperty():
        ...
        @property
        def expiration_date(self) -> typing.Optional[typing.Union[typing.Optional[datetime.datetime], typing.Optional[aws_cdk.core.IResolvable]]]:
    ...
    class TransitionProperty():
        def __init__(self, *, storage_class: str, transition_date: typing.Optional[typing.Union[typing.Optional[datetime.datetime], typing.Optional[aws_cdk.core.IResolvable]]]=None, transition_in_days: typing.Optional[jsii.Number]=None):
            """
        ...
        @property
        def transition_date(self) -> typing.Optional[typing.Union[typing.Optional[datetime.datetime], typing.Optional[aws_cdk.core.IResolvable]]]:
...
class Bucket(aws_cdk.core.Resource, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-s3.Bucket"):
    ...
    def from_bucket_attributes(cls, scope: aws_cdk.core.Construct, id: str, *, bucket_arn: typing.Optional[str]=None, bucket_domain_name: typing.Optional[str]=None, bucket_dual_stack_domain_name: typing.Optional[str]=None, bucket_name: typing.Optional[str]=None, bucket_regional_domain_name: typing.Optional[str]=None, bucket_website_new_url_format: typing.Optional[bool]=None, bucket_website_url: typing.Optional[str]=None) -> "IBucket":
        ...
        :param attrs: A ``BucketAttributes`` object. Can be obtained from a call to ``bucket.export()`` or manually created.
        :param bucket_arn: The ARN of the bucket. At least one of bucketArn or bucketName must be defined in order to initialize a bucket ref.
        :param bucket_domain_name: The domain name of the bucket. Default: Inferred from bucket name
        :param bucket_dual_stack_domain_name: The IPv6 DNS name of the specified bucket.
        :param bucket_name: The name of the bucket. If the underlying value of ARN is a string, the name will be parsed from the ARN. Otherwise, the name is optional, but some features that require the bucket name such as auto-creating a bucket policy, won't work.
