...
__jsii_assembly__ = jsii.JSIIAssembly.load("@aws-cdk/aws-ssm", "1.4.0", __name__, "aws-ssm@1.4.0.jsii.tgz")
...
class CfnAssociationProps():
    ...
    @property
    def output_location(self) -> typing.Optional[typing.Union[typing.Optional["CfnAssociation.InstanceAssociationOutputLocationProperty"], typing.Optional[aws_cdk.core.IResolvable]]]:
        """``AWS::SSM::Association.OutputLocation``.
...
@jsii.data_type(jsii_type="@aws-cdk/aws-ssm.SecureStringParameterAttributes", jsii_struct_bases=[], name_mapping={'parameter_name': 'parameterName', 'version': 'version'})
class SecureStringParameterAttributes():
    def __init__(self, *, parameter_name: str, version: jsii.Number):
        """
...
class StringParameter(aws_cdk.core.Resource, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-ssm.StringParameter"):
    ...
    def __init__(self, scope: aws_cdk.core.Construct, id: str, *, string_value: str, allowed_pattern: typing.Optional[str]=None, description: typing.Optional[str]=None, parameter_name: typing.Optional[str]=None) -> None:
        ...
        :param parameter_name: The name of the parameter. Default: - a name will be generated by CloudFormation
        """
        props = StringParameterProps(string_value=string_value, allowed_pattern=allowed_pattern, description=description, parameter_name=parameter_name)
    ...
    def from_secure_string_parameter_attributes(cls, scope: aws_cdk.core.Construct, id: str, *, parameter_name: str, version: jsii.Number) -> "IStringParameter":
        ...
        :param version: The version number of the value you wish to retrieve. This is required for secure strings.
        """
        attrs = SecureStringParameterAttributes(parameter_name=parameter_name, version=version)
    ...
    def from_string_parameter_attributes(cls, scope: aws_cdk.core.Construct, id: str, *, parameter_name: str, version: typing.Optional[jsii.Number]=None) -> "IStringParameter":
        ...
        """
        attrs = StringParameterAttributes(parameter_name=parameter_name, version=version)
...
@jsii.data_type(jsii_type="@aws-cdk/aws-ssm.StringParameterAttributes", jsii_struct_bases=[], name_mapping={'parameter_name': 'parameterName', 'version': 'version'})
class StringParameterAttributes():
    def __init__(self, *, parameter_name: str, version: typing.Optional[jsii.Number]=None):
        """
        :param parameter_name: The name of the parameter store value.
        :param version: The version number of the value you wish to retrieve. Default: The latest version will be retrieved.
        """
...
@jsii.data_type(jsii_type="@aws-cdk/aws-ssm.StringParameterProps", jsii_struct_bases=[ParameterOptions], name_mapping={'allowed_pattern': 'allowedPattern', 'description': 'description', 'parameter_name': 'parameterName', 'string_value': 'stringValue'})
class StringParameterProps(ParameterOptions):
    def __init__(self, *, allowed_pattern: typing.Optional[str]=None, description: typing.Optional[str]=None, parameter_name: typing.Optional[str]=None, string_value: str):
